<header
    class="fixed z-50 flex flex-wrap w-full py-3 text-sm bg-white border-b border-gray-200 h-28 sm:justify-start sm:flex-nowrap sm:py-0 dark:bg-gray-800 dark:border-gray-700">
    <nav class="relative w-full px-4 mx-auto max-w-7xl sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
        aria-label="Global">
        <div class="flex items-center justify-between">
            <img src="https://www.cip.org.pe/images/LOGO_CIP.png" alt="Logo" class="m-2 max-h-14">
            <a class="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">CIP CAJAMARCA</a>
            <div class="sm:hidden">
                <button type="button"
        ...
        <div id="navbar-collapse-with-animation"
            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <button type="button"
                                class="flex items-center justify-between w-full px-3 py-2 text-sm text-gray-800 rounded-md hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                                Sub Menu
                ...
                <a class="flex items-center font-medium text-gray-500 gap-x-2 hover:text-blue-600 sm:border-l sm:border-gray-300 sm:my-6 sm:pl-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-blue-500"
                    href="#">
